...
//  str_lowercasing : remplace chacune des majuscules (au sens de la fonction
//    isupper de l'en-tête standard <ctype.h>) de la chaine pointée par s par
//    les minuscules associées (au sens de la fonction tolower de l'en-tête
//    standard <ctype.h>). Renvoie s.
extern char *str_lowercasing(char *s);

//  str_uppercasing : remplace chacune des minuscules (au sens de la fonction
//    islower de l'en-tête standard <ctype.h>) de la chaine pointée par s par
//    les majuscules associées (au sens de la fonction toupper de l'en-tête
//    standard <ctype.h>). Renvoie s.
