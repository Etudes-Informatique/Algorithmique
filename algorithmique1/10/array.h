...
//  insert_sort, mergebinsteps_sort, select_sort : même spécification que la
//    fonction qsort déclarée dans l'en-tête standard <stdlib.h>.

extern void insert_sort(void *base, size_t nmemb, size_t size,
    int (*compar)(const void *, const void *));
extern void mergebinsteps_sort(void *base, size_t nmemb, size_t size,
    int (*compar)(const void *, const void *));
